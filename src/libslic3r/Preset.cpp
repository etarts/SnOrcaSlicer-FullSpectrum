...
static std::vector<std::string> s_Preset_print_options {
    ...
    "flush_into_infill", "flush_into_objects", "flush_into_support",
     ...
     "hole_to_polyhole", "hole_to_polyhole_threshold", "hole_to_polyhole_twisted", "mm_color_overlap", "mmu_segmented_region_max_width", "mmu_segmented_region_interlocking_depth",
